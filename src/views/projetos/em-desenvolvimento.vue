    ...
    <div class='main-four'> 
        <div to="/professor">
          ...
          <br>
           <h4>@espirita.xyz</h4>
           <!--
          <a href='https://www.espirita.xyz'><i class="fa-solid fa-link"></i> www.espirita.xyz</a>
          <br>
...
export default {
  head: {
    title: 'Projetos em desenvolvimento | Leandro Cesar',
    htmlAttrs: {
      lang: 'pt-br'
    },
    meta: [
...
.main-five-card a.RouterLink-exact-active {
  color: #000;
}
